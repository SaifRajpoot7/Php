...
?>
    ...
    if (!$conn) {
        ...
        if (empty($_POST['name']) == FALSE && empty($_POST['father-name']) == FALSE && empty($_POST['email']) == FALSE && str_contains($_POST['email'], '@') == TRUE && empty($_POST['contact'] == FALSE)) {
            ...
            if ($result) {
                echo '<div class="alert alert-info alert-dismissible fade show" role="alert">Success! Your note was successfully updated.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
                header("location: http://localhost/php/crud_app_PDO/");
            } else {
                // echo "The record was not inserted successfully because of this error ---> ". mysqli_error($conn);
                echo '<div class="alert alert-info alert-dismissible fade show" role="alert">Unsuccessful! Your note was not successfully update.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
            }
        }
    }
}
